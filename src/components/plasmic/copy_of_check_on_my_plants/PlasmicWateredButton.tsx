...
import sty from "./PlasmicWateredButton.module.css"; // plasmic-import: xcrnevIKtbTBx8/css
...
export type PlasmicWateredButton__VariantMembers = {
...
export type PlasmicWateredButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicWateredButton__VariantsArgs;
export const PlasmicWateredButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicWateredButton__ArgsType = {
...
type ArgPropType = keyof PlasmicWateredButton__ArgsType;
export const PlasmicWateredButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicWateredButton__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultWateredButtonProps extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
function PlasmicWateredButton__RenderFunc(props: {
  variants: PlasmicWateredButton__VariantsArgs;
  args: PlasmicWateredButton__ArgsType;
  overrides: PlasmicWateredButton__OverridesType;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__cZodT)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__thc8U)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicWateredButton>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicWateredButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicWateredButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicWateredButton__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  const func = function <T extends PropsType>(
    ...
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicWateredButton__ArgProps,
      internalVariantPropNames: PlasmicWateredButton__VariantProps
    });

    return PlasmicWateredButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicWateredButton";
  } else {
    func.displayName = `PlasmicWateredButton.${nodeName}`;
  }
  return func;
}

export const PlasmicWateredButton = Object.assign(
  // Top-level PlasmicWateredButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicWateredButton
    internalVariantProps: PlasmicWateredButton__VariantProps,
    internalArgProps: PlasmicWateredButton__ArgProps,

    useBehavior
  }
);

export default PlasmicWateredButton;
/* prettier-ignore-end */
