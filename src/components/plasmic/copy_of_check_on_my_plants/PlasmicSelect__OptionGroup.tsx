...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: E2J7BA6ReKrT3s/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: _GSXdVTKgkaYcn/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__cGiI)}
              >
                <div
                  className={classNames(
                    projectcss.all,
              ...
              <Select__Option
                className={classNames("__wab_instance", sty.option__yXoA2)}
              />
            </React.Fragment>
          ),
          value: args.children
