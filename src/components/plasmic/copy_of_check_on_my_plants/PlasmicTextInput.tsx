...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: B6C4ENEJH6xECw/css
  ...
  return (
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__sKh8F)}
                role={"img"}
              />
            ),
      ...
      <input
        ...
        name={args.name}
        placeholder={
          args.placeholder !== undefined ? args.placeholder : ("Name" as const)
        }
        type={"text" as const}
        value={args.value}
      />
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ra15Q)}
                role={"img"}
              />
            ),
